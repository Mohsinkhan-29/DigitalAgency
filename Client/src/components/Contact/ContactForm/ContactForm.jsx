      ...
      <div className="mt-[2px]" style={{ color: "#DC2626" }}>
        ...
        >
          <path
            ...
            d="M12 9v2m0 4h.01M10.29 3.86l-7.5 13A2 2 0 004.5 20h15a2 2 0 001.71-3l-7.5-13a2 2 0 00-3.42 0z"
          />
        </svg>
      </div>
...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    const percent = Math.round(
      (total / Object.keys(validations).length) * 100
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://digitalagency-pmrq.onrender.com/api/contact",
        {
          method: "POST",
          headers: {
            "Content-Type":
  ...
  if (submitted) {
    return (
      ...
      >
        <div className="rounded-3xl shadow-xl p-10 max-w-md w-full text-center"
          style={{
            background: "#FFFFFF",
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[380px_1fr] gap-10">
        ...
        <div className="lg:sticky top-8 h-fit self-start">
          ...
          <p
            ...
            style={{ color: "#166534" }}
          >
            Whether you have a project in mind, a question, or simply
            want to explore opportunities — our team is ready to help.
          </p>
          ...
          >
            ...
            <p
              ...
              style={{ color: "#166534" }}
            >
              Our team is currently available for new projects starting Q3
              2025
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <h3
                      className="mt-1 text-[15px] font-bold leading-6"
                      style={{ color: "#0F172A" }}
                    >
                      {card.value}
                    </h3>
        ...
        >
          ...
          {/* PROGRESS */}
          <div className="sticky top-0 md:top-20 z-30 px-6 md:px-10 py-5 border-b backdrop-blur-xl rounded-t-[34px]"
            style={{
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div
                ...
                style={{
                  background: progress === 100 ? "#DCFCE7" : "#DCFCE7",
                  color: "#166534",
                }}
              >
                {progress}% Complete
          ...
          <div className="p-6 md:p-10">
              ...
              },
              {
                ...
                <div key={input.field}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInput(input.field, e.target.value)
                    }
            ...
            {/* BUTTON + REST (unchanged structure, same palette applied similarly) */}
            ...
            <button
              ...
              className="w-full mt-10 py-5 rounded-2xl font-bold text-lg transition-all text-white"
              style={{
                background: isFormValid ? "#16A34A" : "#BBF7D0",
                color: isFormValid ? "#FFFFFF" : "#052E16",
              }}
            >
              {isFormValid ? "Send Message →" : `Complete Form (${progress}%)`}
            </button>
          </div>
        </form>
      </div>
